 ...
 * @generated
 */
public class CrosswalkPropertySection extends AdvancedPropertySection implements
		...
		if (object instanceof IPropertySource) {
			...
			if (af != null) {
				...
				if (object instanceof DelimitedFile) {
					result = new MyFileURLPropertySource(object, ips);
				} else if (ips != null) {
					result = new HelpfulPropertySource(object, ips);
				}
			} else {
