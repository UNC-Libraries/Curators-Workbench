 ...
 * @generated
 */
public class TrimWhitespaceOutputElementInputsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
			.getTrimWhitespaceOutputElementInputsCompartment_7014SemanticChildren(viewObject);
	...
	return StringInput12EditPart.VISUAL_ID == CrosswalkVisualIDRegistry.getVisualID(view);
    }
	...
	List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
			.getTrimWhitespaceOutputElementInputsCompartment_7014SemanticChildren((View) getHost()
					.getModel());
