...
public class TrimWhitespaceOutputElementInputsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
			.getTrimWhitespaceGenericWidgetCompartment_7014SemanticChildren(viewObject);
	...
	return StringInput2EditPart.VISUAL_ID == CrosswalkVisualIDRegistry.getVisualID(view);
    }
	...
	List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
			.getTrimWhitespaceGenericWidgetCompartment_7014SemanticChildren((View) getHost().getModel());
