 ...
 * @generated
 */
public class DictionaryModelBoxCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return CrosswalkPackage.eINSTANCE.getDictionary_Blocks();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
				.getDictionaryModelBoxCompartment_7005SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return MetadataBlockEditPart.VISUAL_ID == CrosswalkVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
				.getDictionaryModelBoxCompartment_7005SemanticChildren((View) getHost().getModel());
