 ...
 * @generated
 */
public class DictionaryModelBoxCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return MetadataBlockEditPart.VISUAL_ID == CrosswalkVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
				.getDictionaryModelBoxCompartment_7005SemanticChildren((View) getHost()
						.getModel());
