 ...
 * @generated
 */
public class MetadataBlockMetadataBlockInputFieldsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
				.getMetadataBlockMetadataBlockInputFieldsCompartment_7009SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
				.getMetadataBlockMetadataBlockInputFieldsCompartment_7009SemanticChildren((View) getHost().getModel());
