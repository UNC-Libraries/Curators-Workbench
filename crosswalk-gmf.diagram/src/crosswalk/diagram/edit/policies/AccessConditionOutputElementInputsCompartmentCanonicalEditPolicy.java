 ...
 * @generated
 */
public class AccessConditionOutputElementInputsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
			.getAccessConditionOutputElementInputsCompartment_7012SemanticChildren(viewObject);
	...
	return StringInput10EditPart.VISUAL_ID == CrosswalkVisualIDRegistry.getVisualID(view);
    }
	...
	List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
			.getAccessConditionOutputElementInputsCompartment_7012SemanticChildren((View) getHost()
					.getModel());
