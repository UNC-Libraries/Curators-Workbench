...
public class CrossWalkCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return CrosswalkPackage.eINSTANCE.getMappingContainer_Widgets();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
				.getCrossWalk_2001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == CurrentDateEditPart.VISUAL_ID || visualID == CurrentUsernameEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
				.getCrossWalk_2001SemanticChildren((View) getHost().getModel());
