 ...
 * @generated
 */
public class MetadataBlockMetadataBlockInputFieldsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return CrosswalkPackage.eINSTANCE.getMetadataBlock_Ports();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
				.getMetadataBlockMetadataBlockInputFieldsCompartment_7012SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
				.getMetadataBlockMetadataBlockInputFieldsCompartment_7012SemanticChildren((View) getHost().getModel());
