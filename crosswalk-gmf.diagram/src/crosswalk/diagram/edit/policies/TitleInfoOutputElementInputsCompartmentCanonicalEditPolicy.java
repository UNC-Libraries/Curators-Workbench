 ...
 * @generated
 */
public class TitleInfoOutputElementInputsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
			.getTitleInfoOutputElementInputsCompartment_7002SemanticChildren(viewObject);
	...
	List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
			.getTitleInfoOutputElementInputsCompartment_7002SemanticChildren((View) getHost().getModel());
