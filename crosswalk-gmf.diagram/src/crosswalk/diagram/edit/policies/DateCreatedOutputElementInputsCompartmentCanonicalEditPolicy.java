 ...
 * @generated
 */
public class DateCreatedOutputElementInputsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
			.getDateCreatedOutputElementInputsCompartment_7011SemanticChildren(viewObject);
	...
	return DateInputEditPart.VISUAL_ID == CrosswalkVisualIDRegistry.getVisualID(view);
    }
	...
	List<CrosswalkNodeDescriptor> childDescriptors = CrosswalkDiagramUpdater
			.getDateCreatedOutputElementInputsCompartment_7011SemanticChildren((View) getHost().getModel());
