...
import crosswalk.diagram.edit.policies.NameItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NameEditPart extends ShapeNodeEditPart {
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new NameItemSemanticEditPolicy());
	...
	if (childEditPart instanceof WrappingLabel6EditPart) {
	    ((WrappingLabel6EditPart) childEditPart).setLabel(getPrimaryShape().getFigureOutputElementLabelFigure());
	    return true;
	}
	if (childEditPart instanceof NameOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.add(((NameOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (childEditPart instanceof NameOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.remove(((NameOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (editPart instanceof NameOutputElementInputsCompartmentEditPart) {
	...
	if (request instanceof CreateViewAndElementRequest) {
	    ...
	    if (type == CrosswalkElementTypes.StringInput_3007) {
		return getChildBySemanticHint(CrosswalkVisualIDRegistry
				.getType(NameOutputElementInputsCompartmentEditPart.VISUAL_ID));
	    }
	}
