...
import crosswalk.diagram.edit.policies.AbstractItemSemanticEditPolicy;
...
public class AbstractEditPart extends ShapeNodeEditPart {
	...
	if (childEditPart instanceof AbstractOutputElementInputsCompartmentEditPart) {
	    ...
	    pane.add(((AbstractOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (childEditPart instanceof AbstractOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.remove(((AbstractOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (editPart instanceof AbstractOutputElementInputsCompartmentEditPart) {
