 ...
 * @generated
 */
public class FileBlockDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FileBlockDescriptionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new CrosswalkTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new EditingContainerEditPart.NodeLabelDragPolicy());
	}
			...
			parser = CrosswalkParserProvider
					.getParser(
							...
							CrosswalkVisualIDRegistry
									.getType(crosswalk.diagram.edit.parts.FileBlockDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
