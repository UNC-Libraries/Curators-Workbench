...
import crosswalk.diagram.edit.policies.TypeOfResourceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TypeOfResourceEditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public TypeOfResourceEditPart(View view) {
	super(view);
    }
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TypeOfResourceItemSemanticEditPolicy());
	...
	if (childEditPart instanceof TypeOfResourceOutputElementInputsCompartmentEditPart) {
	    ...
	    pane.add(((TypeOfResourceOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (childEditPart instanceof TypeOfResourceOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.remove(((TypeOfResourceOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (editPart instanceof TypeOfResourceOutputElementInputsCompartmentEditPart) {
