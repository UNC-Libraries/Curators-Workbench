...
import crosswalk.diagram.edit.policies.IdentifierItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IdentifierEditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public IdentifierEditPart(View view) {
	super(view);
    }
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IdentifierItemSemanticEditPolicy());
	...
	if (childEditPart instanceof IdentifierOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.add(((IdentifierOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (childEditPart instanceof IdentifierOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.remove(((IdentifierOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (editPart instanceof IdentifierOutputElementInputsCompartmentEditPart) {
