...
import crosswalk.diagram.edit.policies.StringInput2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StringInput2EditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public StringInput2EditPart(View view) {
	super(view);
    }
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StringInput2ItemSemanticEditPolicy());
	...
	if (childEditPart instanceof StringInputName2EditPart) {
	    ((StringInputName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabel());
	    return true;
	}
	return false;
    }
	...
	return getChildBySemanticHint(CrosswalkVisualIDRegistry.getType(StringInputName2EditPart.VISUAL_ID));
    }
