...
import crosswalk.diagram.edit.policies.DateCreatedItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DateCreatedEditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public DateCreatedEditPart(View view) {
	super(view);
    }
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DateCreatedItemSemanticEditPolicy());
	...
	if (childEditPart instanceof DateCreatedOutputElementInputsCompartmentEditPart) {
	    ...
	    pane.add(((DateCreatedOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (childEditPart instanceof DateCreatedOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.remove(((DateCreatedOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (editPart instanceof DateCreatedOutputElementInputsCompartmentEditPart) {
