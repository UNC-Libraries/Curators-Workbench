...
import crosswalk.diagram.edit.policies.DateRecognizer2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DateRecognizer2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DateRecognizer2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DateRecognizer2ItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof crosswalk.diagram.edit.parts.DateRecognizer2EditPart) {
			types.add(CrosswalkElementTypes.InputOutput_4001);
		}
