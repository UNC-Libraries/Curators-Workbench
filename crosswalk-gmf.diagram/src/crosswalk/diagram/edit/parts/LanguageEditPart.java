...
import crosswalk.diagram.edit.policies.LanguageItemSemanticEditPolicy;
...
public class LanguageEditPart extends ShapeNodeEditPart {
	...
	if (childEditPart instanceof WrappingLabel7EditPart) {
	    ((WrappingLabel7EditPart) childEditPart).setLabel(getPrimaryShape().getFigureOutputElementLabelFigure());
	    return true;
	}
	if (childEditPart instanceof LanguageOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.add(((LanguageOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (childEditPart instanceof LanguageOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.remove(((LanguageOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (editPart instanceof LanguageOutputElementInputsCompartmentEditPart) {
	...
	if (request instanceof CreateViewAndElementRequest) {
		...
		return getChildBySemanticHint(CrosswalkVisualIDRegistry
				.getType(LanguageOutputElementInputsCompartmentEditPart.VISUAL_ID));
	    }
	}
