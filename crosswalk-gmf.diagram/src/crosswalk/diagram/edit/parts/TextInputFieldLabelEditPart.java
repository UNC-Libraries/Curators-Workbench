 ...
 * @generated
 */
public class TextInputFieldLabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = CrosswalkParserProvider
					.getParser(
							...
							CrosswalkVisualIDRegistry
									.getType(crosswalk.diagram.edit.parts.TextInputFieldLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
