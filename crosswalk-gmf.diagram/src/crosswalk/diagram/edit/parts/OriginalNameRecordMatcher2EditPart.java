...
import crosswalk.diagram.edit.policies.OriginalNameRecordMatcher2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OriginalNameRecordMatcher2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public OriginalNameRecordMatcher2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OriginalNameRecordMatcher2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel8EditPart) {
			((WrappingLabel8EditPart) childEditPart).setLabel(getPrimaryShape().getFigureWidgetLabelFigure());
			return true;
		}
		return false;
	}
