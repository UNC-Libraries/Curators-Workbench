 ...
 * @generated
 */
public class FileBlockNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FileBlockNameEditPart(View view) {
		super(view);
	}
			...
			parser = CrosswalkParserProvider
					.getParser(
							...
							CrosswalkVisualIDRegistry
									.getType(crosswalk.diagram.edit.parts.FileBlockNameEditPart.VISUAL_ID));
		}
		return parser;
	}
