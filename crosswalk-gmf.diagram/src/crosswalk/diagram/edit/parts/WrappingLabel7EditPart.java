...
public class WrappingLabel7EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrosswalkParserProvider.getParser(CrosswalkElementTypes.MappedAttribute_3009, getParserElement(),
					CrosswalkVisualIDRegistry.getType(crosswalk.diagram.edit.parts.WrappingLabel7EditPart.VISUAL_ID));
		}
		return parser;
	}
