...
import crosswalk.diagram.edit.policies.StringInput13ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StringInput13EditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public StringInput13EditPart(View view) {
	super(view);
    }
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StringInput13ItemSemanticEditPolicy());
	...
	if (childEditPart instanceof StringInputName13EditPart) {
	    ((StringInputName13EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabel());
	    return true;
	}
	return false;
    }
	...
	return getChildBySemanticHint(CrosswalkVisualIDRegistry.getType(StringInputName13EditPart.VISUAL_ID));
    }
