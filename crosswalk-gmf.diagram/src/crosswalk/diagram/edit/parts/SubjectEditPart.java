...
import crosswalk.diagram.edit.policies.SubjectItemSemanticEditPolicy;
...
public class SubjectEditPart extends ShapeNodeEditPart {
	...
	if (childEditPart instanceof SubjectOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.add(((SubjectOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (childEditPart instanceof SubjectOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.remove(((SubjectOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (editPart instanceof SubjectOutputElementInputsCompartmentEditPart) {
	...
	if (request instanceof CreateViewAndElementRequest) {
		...
		return getChildBySemanticHint(CrosswalkVisualIDRegistry
				.getType(SubjectOutputElementInputsCompartmentEditPart.VISUAL_ID));
	    }
	}
