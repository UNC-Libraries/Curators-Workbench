...
import crosswalk.diagram.edit.policies.StringInput10ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StringInput10EditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public StringInput10EditPart(View view) {
	super(view);
    }
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StringInput10ItemSemanticEditPolicy());
	...
	if (childEditPart instanceof StringInputName10EditPart) {
	    ((StringInputName10EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabel());
	    return true;
	}
	return false;
    }
	...
	return getChildBySemanticHint(CrosswalkVisualIDRegistry.getType(StringInputName10EditPart.VISUAL_ID));
    }
