...
public class StringInput10EditPart extends ShapeNodeEditPart {
	...
	if (childEditPart instanceof StringInputName9EditPart) {
	    ((StringInputName9EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabel());
	    return true;
	}
	return false;
    }
	...
	return getChildBySemanticHint(CrosswalkVisualIDRegistry.getType(StringInputName9EditPart.VISUAL_ID));
    }
