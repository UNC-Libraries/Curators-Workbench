 ...
 * @generated
 */
public class DateInputFieldLabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = CrosswalkParserProvider
					.getParser(
							...
							CrosswalkVisualIDRegistry
									.getType(crosswalk.diagram.edit.parts.DateInputFieldLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
