...
public class WrappingLabel2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrosswalkParserProvider.getParser(CrosswalkElementTypes.OriginalNameRecordMatcher_3003,
					getParserElement(),
					CrosswalkVisualIDRegistry.getType(crosswalk.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
