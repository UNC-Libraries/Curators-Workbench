...
import crosswalk.diagram.edit.policies.StringInput7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StringInput7EditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public StringInput7EditPart(View view) {
	super(view);
    }
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StringInput7ItemSemanticEditPolicy());
	...
	if (childEditPart instanceof StringInputName7EditPart) {
	    ((StringInputName7EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabel());
	    return true;
	}
	return false;
    }
	...
	return getChildBySemanticHint(CrosswalkVisualIDRegistry.getType(StringInputName7EditPart.VISUAL_ID));
    }
