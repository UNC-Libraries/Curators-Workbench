...
public class StringInput7EditPart extends ShapeNodeEditPart {
	...
	if (childEditPart instanceof StringInputName6EditPart) {
	    ((StringInputName6EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabel());
	    return true;
	}
	return false;
    }
	...
	return getChildBySemanticHint(CrosswalkVisualIDRegistry.getType(StringInputName6EditPart.VISUAL_ID));
    }
