 ...
 * @generated
 */
public class MetadataBlockName3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = CrosswalkParserProvider
					.getParser(
							...
							CrosswalkVisualIDRegistry
									.getType(crosswalk.diagram.edit.parts.MetadataBlockName3EditPart.VISUAL_ID));
		}
		return parser;
	}
