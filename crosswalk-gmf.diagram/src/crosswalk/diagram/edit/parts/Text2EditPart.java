...
import crosswalk.diagram.edit.policies.Text2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Text2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Text2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Text2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextValue2EditPart) {
			((TextValue2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureWidgetLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CrosswalkVisualIDRegistry.getType(TextValue2EditPart.VISUAL_ID));
	}
