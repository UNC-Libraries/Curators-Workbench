 ...
 * @generated
 */
public class TabbedDataFieldLabelColumnNumberEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TabbedDataFieldLabelColumnNumberEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrosswalkParserProvider.getParser(CrosswalkElementTypes.TabbedDataField_3002, getParserElement(),
