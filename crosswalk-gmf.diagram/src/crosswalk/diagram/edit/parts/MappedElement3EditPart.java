...
import crosswalk.diagram.edit.policies.MappedElement3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MappedElement3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public MappedElement3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MappedElement3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel11EditPart) {
			((WrappingLabel11EditPart) childEditPart).setLabel(getPrimaryShape().getLabel());
			return true;
		}
		if (childEditPart instanceof MappedElementChildElementsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getChildPane();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((MappedElementChildElementsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof MappedElementChildElementsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getChildPane();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((MappedElementChildElementsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof MappedElementChildElementsCompartment3EditPart) {
		...
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == CrosswalkElementTypes.MappedElement_3008) {
				return getChildBySemanticHint(CrosswalkVisualIDRegistry
						.getType(MappedElementChildElementsCompartment3EditPart.VISUAL_ID));
			}
