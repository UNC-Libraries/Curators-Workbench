...
public class StringInput9EditPart extends ShapeNodeEditPart {
	...
	if (childEditPart instanceof StringInputName8EditPart) {
	    ((StringInputName8EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabel());
	    return true;
	}
	return false;
    }
	...
	return getChildBySemanticHint(CrosswalkVisualIDRegistry.getType(StringInputName8EditPart.VISUAL_ID));
    }
