...
import crosswalk.diagram.edit.policies.StringInput4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StringInput4EditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public StringInput4EditPart(View view) {
	super(view);
    }
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new StringInput4ItemSemanticEditPolicy());
	...
	if (childEditPart instanceof StringInputName3EditPart) {
	    ((StringInputName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabel());
	    return true;
	}
	return false;
    }
	...
	return getChildBySemanticHint(CrosswalkVisualIDRegistry.getType(StringInputName3EditPart.VISUAL_ID));
    }
