...
public class WrappingLabel5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrosswalkParserProvider.getParser(CrosswalkElementTypes.MappedElement_3007, getParserElement(),
					CrosswalkVisualIDRegistry.getType(crosswalk.diagram.edit.parts.WrappingLabel5EditPart.VISUAL_ID));
		}
		return parser;
	}
