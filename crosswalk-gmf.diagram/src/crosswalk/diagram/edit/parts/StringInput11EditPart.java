...
public class StringInput11EditPart extends ShapeNodeEditPart {
	...
	if (childEditPart instanceof StringInputName11EditPart) {
	    ((StringInputName11EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabel());
	    return true;
	}
	return false;
    }
	...
	return getChildBySemanticHint(CrosswalkVisualIDRegistry.getType(StringInputName11EditPart.VISUAL_ID));
    }
