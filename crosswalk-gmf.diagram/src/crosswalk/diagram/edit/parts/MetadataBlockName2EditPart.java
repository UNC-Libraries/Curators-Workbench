 ...
 * @generated
 */
public class MetadataBlockName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = CrosswalkParserProvider
					.getParser(
							...
							CrosswalkVisualIDRegistry
									.getType(crosswalk.diagram.edit.parts.MetadataBlockName2EditPart.VISUAL_ID));
		}
		return parser;
	}
