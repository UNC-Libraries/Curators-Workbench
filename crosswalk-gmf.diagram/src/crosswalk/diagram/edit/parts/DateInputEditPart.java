...
import crosswalk.diagram.edit.policies.DateInputItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DateInputEditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public DateInputEditPart(View view) {
	super(view);
    }
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DateInputItemSemanticEditPolicy());
	...
	if (childEditPart instanceof DateInputNameEditPart) {
	    ((DateInputNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabel());
	    return true;
	}
	return false;
    }
	...
	return getChildBySemanticHint(CrosswalkVisualIDRegistry.getType(DateInputNameEditPart.VISUAL_ID));
    }
