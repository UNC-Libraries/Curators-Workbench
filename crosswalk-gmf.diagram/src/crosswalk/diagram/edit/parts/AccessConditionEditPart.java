...
import crosswalk.diagram.edit.policies.AccessConditionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AccessConditionEditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public AccessConditionEditPart(View view) {
	super(view);
    }
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AccessConditionItemSemanticEditPolicy());
	...
	if (childEditPart instanceof AccessConditionOutputElementInputsCompartmentEditPart) {
	    ...
	    pane.add(((AccessConditionOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (childEditPart instanceof AccessConditionOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.remove(((AccessConditionOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (editPart instanceof AccessConditionOutputElementInputsCompartmentEditPart) {
