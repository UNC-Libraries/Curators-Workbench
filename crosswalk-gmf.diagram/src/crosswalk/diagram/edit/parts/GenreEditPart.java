...
import crosswalk.diagram.edit.policies.GenreItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GenreEditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public GenreEditPart(View view) {
	super(view);
    }
	...
	installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GenreItemSemanticEditPolicy());
	...
	if (childEditPart instanceof GenreOutputElementInputsCompartmentEditPart) {
	    ...
	    pane.add(((GenreOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (childEditPart instanceof GenreOutputElementInputsCompartmentEditPart) {
	    IFigure pane = getPrimaryShape().getContentPane();
	    setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
	    pane.remove(((GenreOutputElementInputsCompartmentEditPart) childEditPart).getFigure());
	    return true;
	}
	return false;
    }
	...
	if (editPart instanceof GenreOutputElementInputsCompartmentEditPart) {
