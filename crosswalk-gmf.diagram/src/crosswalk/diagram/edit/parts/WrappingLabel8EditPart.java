...
public class WrappingLabel8EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CrosswalkParserProvider.getParser(CrosswalkElementTypes.CurrentDate_3021, getParserElement(),
					CrosswalkVisualIDRegistry.getType(crosswalk.diagram.edit.parts.WrappingLabel8EditPart.VISUAL_ID));
		}
		return parser;
	}
