...
import crosswalk.diagram.edit.policies.TrimWhitespace2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TrimWhitespace2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public TrimWhitespace2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TrimWhitespace2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof WrappingLabel10EditPart) {
			((WrappingLabel10EditPart) childEditPart).setLabel(getPrimaryShape().getFigureWidgetLabelFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if (targetEditPart instanceof crosswalk.diagram.edit.parts.TrimWhitespace2EditPart) {
			types.add(CrosswalkElementTypes.InputOutput_4001);
		}
