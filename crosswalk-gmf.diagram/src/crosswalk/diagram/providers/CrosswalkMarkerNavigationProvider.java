...
import crosswalk.diagram.part.CrosswalkDiagramEditorUtil;

/**
 * @generated
 */
public class CrosswalkMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = CrosswalkDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			CrosswalkDiagramEditorUtil.selectElementsInDiagram(editor,
