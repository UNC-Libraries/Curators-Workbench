 ...
 */
package crosswalk.diagram.expressions;
 ...
 * @generated
 */
public abstract class CrosswalkAbstractExpression {
	...
	String pluginID = CrosswalkDiagramEditorPlugin.ID;
     ...
     * @generated
     */
    protected CrosswalkAbstractExpression(String body, EClassifier context) {
	myBody = body;
	myContext = context;
    }
	...
	if (context().isInstance(context)) {
		...
		CrosswalkDiagramEditorPlugin.getInstance().logError("Expression evaluation failure: " + body(), e); //$NON-NLS-1$
	    }
	}
	return null;
    }
