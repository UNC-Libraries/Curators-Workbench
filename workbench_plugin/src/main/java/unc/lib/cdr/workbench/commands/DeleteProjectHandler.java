...
public class DeleteProjectHandler extends AbstractHandler implements IHandler {
	...
	for (Object foo : sel.toArray()) {
		...
		MessageDialogWithToggle mdwt = MessageDialogWithToggle.openOkCancelConfirm(HandlerUtil.getActiveShellChecked(event),
				"Delete Project",
				"Are you sure you want to delete this project from the workbench?\n\n\t" + p.getName(),
				"Delete workbench-generated files on disk? (Does not including originals.)",
				false, null, null);
