...
public class PhysicalDescriptionDefinitionItemProvider extends ItemProviderAdapter implements
	...
	protected void addDigitalOriginPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_PhysicalDescriptionDefinition_digitalOrigin_feature",
						"_UI_PhysicalDescriptionDefinition_type"), MODSPackage.eINSTANCE
	...
	protected void addAltRepGroupPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_PhysicalDescriptionDefinition_altRepGroup_feature",
						"_UI_PhysicalDescriptionDefinition_type"), MODSPackage.eINSTANCE
	...
	protected void addDisplayLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_PhysicalDescriptionDefinition_displayLabel_feature",
						"_UI_PhysicalDescriptionDefinition_type"), MODSPackage.eINSTANCE
	...
	protected void addLangPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_PhysicalDescriptionDefinition_lang_feature",
						"_UI_PhysicalDescriptionDefinition_type"), MODSPackage.eINSTANCE
	...
	protected void addLang1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_PhysicalDescriptionDefinition_lang1_feature",
						"_UI_PhysicalDescriptionDefinition_type"), MODSPackage.eINSTANCE
	...
	protected void addScriptPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_PhysicalDescriptionDefinition_script_feature",
						"_UI_PhysicalDescriptionDefinition_type"), MODSPackage.eINSTANCE
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getPhysicalDescriptionDefinition_Group(),
				FeatureMapUtil.createEntry(MODSPackage.eINSTANCE.getPhysicalDescriptionDefinition_ReformattingQuality(),
						ReformattingQualityDefinition.ACCESS)));

		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getPhysicalDescriptionDefinition_Group(),
				FeatureMapUtil.createEntry(MODSPackage.eINSTANCE.getPhysicalDescriptionDefinition_InternetMediaType(),
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getPhysicalDescriptionDefinition_Group(),
				FeatureMapUtil.createEntry(MODSPackage.eINSTANCE.getPhysicalDescriptionDefinition_DigitalOrigin(),
