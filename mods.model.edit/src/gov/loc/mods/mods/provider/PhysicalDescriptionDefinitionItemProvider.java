 ...
 * @generated
 */
public class PhysicalDescriptionDefinitionItemProvider extends
	 ...
	 * @generated
	 */
	public PhysicalDescriptionDefinitionItemProvider(
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_PhysicalDescriptionDefinition_type"),
						MODSPackage.eINSTANCE
								.getPhysicalDescriptionDefinition_ReformattingQuality(),
						true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_PhysicalDescriptionDefinition_type"),
						MODSPackage.eINSTANCE
								.getPhysicalDescriptionDefinition_DigitalOrigin(),
						true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_PhysicalDescriptionDefinition_type"),
						MODSPackage.eINSTANCE
								.getPhysicalDescriptionDefinition_AltRepGroup(),
						true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_PhysicalDescriptionDefinition_type"),
						MODSPackage.eINSTANCE
								.getPhysicalDescriptionDefinition_DisplayLabel(),
						true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addLangPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_PhysicalDescriptionDefinition_type"),
				MODSPackage.eINSTANCE.getPhysicalDescriptionDefinition_Lang(),
	...
	protected void addLang1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_PhysicalDescriptionDefinition_type"),
				MODSPackage.eINSTANCE.getPhysicalDescriptionDefinition_Lang1(),
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_PhysicalDescriptionDefinition_type"),
						MODSPackage.eINSTANCE
								.getPhysicalDescriptionDefinition_Script(),
						true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_PhysicalDescriptionDefinition_type"),
						MODSPackage.eINSTANCE
								.getPhysicalDescriptionDefinition_Transliteration(),
						true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MODSPackage.eINSTANCE
					.getPhysicalDescriptionDefinition_Group());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/PhysicalDescriptionDefinition"));
	}
	...
	public String getText(Object object) {
		String label = ((PhysicalDescriptionDefinition) object)
				.getAltRepGroup();
		return label == null || label.length() == 0 ? getString("_UI_PhysicalDescriptionDefinition_type")
				: getString("_UI_PhysicalDescriptionDefinition_type") + " "
						+ label;
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getPhysicalDescriptionDefinition_Group(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getPhysicalDescriptionDefinition_Form(),
						MODSFactory.eINSTANCE
								.createStringPlusAuthorityPlusType())));
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				...
				.createEntry(MODSPackage.eINSTANCE
						.getPhysicalDescriptionDefinition_Form(),
						MODSFactory.eINSTANCE
								.createPhysicalLocationDefinition())));
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getPhysicalDescriptionDefinition_Group(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getPhysicalDescriptionDefinition_InternetMediaType(),
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				...
				.createEntry(MODSPackage.eINSTANCE
						.getPhysicalDescriptionDefinition_InternetMediaType(),
						MODSFactory.eINSTANCE
								.createUnstructuredTextDefinition())));
				...
				.add(createChildParameter(
						...
						FeatureMapUtil.createEntry(
								MODSPackage.eINSTANCE
										.getPhysicalDescriptionDefinition_InternetMediaType(),
								MODSFactory.eINSTANCE
										.createGeographicCodeDefinition())));
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				...
				.createEntry(MODSPackage.eINSTANCE
						.getPhysicalDescriptionDefinition_InternetMediaType(),
						MODSFactory.eINSTANCE
								.createRecordIdentifierDefinition())));
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getPhysicalDescriptionDefinition_Group(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getPhysicalDescriptionDefinition_Extent(),
						MODSFactory.eINSTANCE.createStringPlusSupplied())));
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getPhysicalDescriptionDefinition_Group(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getPhysicalDescriptionDefinition_Note(),
						MODSFactory.eINSTANCE.createNoteBaseDefinition())));
