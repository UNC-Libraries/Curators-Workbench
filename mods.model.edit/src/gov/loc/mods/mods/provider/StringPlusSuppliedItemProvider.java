...
/**
 * This is the item provider adapter for a {@link gov.loc.mods.mods.StringPlusSupplied} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringPlusSuppliedItemProvider extends XsStringItemProvider implements IEditingDomainItemProvider,
     ...
     * @generated
     */
    public StringPlusSuppliedItemProvider(AdapterFactory adapterFactory) {
    ...
    /**
     * This returns StringPlusSupplied.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
	...
	String label = ((StringPlusSupplied) object).getValue();
	return label == null || label.length() == 0 ? getString("_UI_StringPlusSupplied_type")
			: getString("_UI_StringPlusSupplied_type") + " " + label;
    }
