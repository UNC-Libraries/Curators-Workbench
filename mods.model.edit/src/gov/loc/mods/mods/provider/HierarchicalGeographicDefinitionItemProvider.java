 ...
 * @generated
 */
public class HierarchicalGeographicDefinitionItemProvider extends
	 ...
	 * @generated
	 */
	public HierarchicalGeographicDefinitionItemProvider(
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_HierarchicalGeographicDefinition_type"),
						MODSPackage.eINSTANCE
								.getHierarchicalGeographicDefinition_Authority(),
						true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_HierarchicalGeographicDefinition_type"),
						MODSPackage.eINSTANCE
								.getHierarchicalGeographicDefinition_AuthorityURI(),
						true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_HierarchicalGeographicDefinition_type"),
						MODSPackage.eINSTANCE
								.getHierarchicalGeographicDefinition_ValueURI(),
						true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MODSPackage.eINSTANCE
					.getHierarchicalGeographicDefinition_Group());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/HierarchicalGeographicDefinition"));
	}
	...
	public String getText(Object object) {
		String label = ((HierarchicalGeographicDefinition) object)
				.getAuthority();
		return label == null || label.length() == 0 ? getString("_UI_HierarchicalGeographicDefinition_type")
				: getString("_UI_HierarchicalGeographicDefinition_type") + " "
						+ label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification
				.getFeatureID(HierarchicalGeographicDefinition.class)) {
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getHierarchicalGeographicDefinition_Group(), FeatureMapUtil
