 ...
 * @generated
 */
public class RelatedItemDefinitionItemProvider extends ItemProviderAdapter
	...
	protected void addActuatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RelatedItemDefinition_actuate_feature",
						"_UI_RelatedItemDefinition_type"),
				MODSPackage.eINSTANCE.getRelatedItemDefinition_Actuate(), true,
	...
	protected void addArcrolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RelatedItemDefinition_arcrole_feature",
						"_UI_RelatedItemDefinition_type"),
				MODSPackage.eINSTANCE.getRelatedItemDefinition_Arcrole(), true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addDisplayLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_RelatedItemDefinition_type"),
				MODSPackage.eINSTANCE.getRelatedItemDefinition_DisplayLabel(),
	...
	protected void addHrefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RelatedItemDefinition_href_feature",
						"_UI_RelatedItemDefinition_type"),
				MODSPackage.eINSTANCE.getRelatedItemDefinition_Href(), true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RelatedItemDefinition_iD_feature",
						"_UI_RelatedItemDefinition_type"),
				MODSPackage.eINSTANCE.getRelatedItemDefinition_ID(), true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RelatedItemDefinition_role_feature",
						"_UI_RelatedItemDefinition_type"),
				MODSPackage.eINSTANCE.getRelatedItemDefinition_Role(), true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addShowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RelatedItemDefinition_show_feature",
						"_UI_RelatedItemDefinition_type"),
				MODSPackage.eINSTANCE.getRelatedItemDefinition_Show(), true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RelatedItemDefinition_title_feature",
						"_UI_RelatedItemDefinition_type"),
				MODSPackage.eINSTANCE.getRelatedItemDefinition_Title(), true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RelatedItemDefinition_type_feature",
						"_UI_RelatedItemDefinition_type"),
				MODSPackage.eINSTANCE.getRelatedItemDefinition_Type(), true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addType1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_RelatedItemDefinition_type1_feature",
						"_UI_RelatedItemDefinition_type"),
				MODSPackage.eINSTANCE.getRelatedItemDefinition_Type1(), true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MODSPackage.eINSTANCE
					.getRelatedItemDefinition_ModsGroup());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/RelatedItemDefinition"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getRelatedItemDefinition_ModsGroup(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getRelatedItemDefinition_Abstract(),
				...
				.add(createChildParameter(MODSPackage.eINSTANCE
						...
						.createEntry(MODSPackage.eINSTANCE
								...
								MODSFactory.eINSTANCE
										.createAccessConditionDefinition())));
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getRelatedItemDefinition_ModsGroup(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getRelatedItemDefinition_Extension(),
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getRelatedItemDefinition_ModsGroup(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getRelatedItemDefinition_Identifier(),
						MODSFactory.eINSTANCE.createIdentifierDefinition())));

		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getRelatedItemDefinition_ModsGroup(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getRelatedItemDefinition_Language(),
						MODSFactory.eINSTANCE.createLanguageDefinition())));

		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getRelatedItemDefinition_ModsGroup(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getRelatedItemDefinition_Location(),
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getRelatedItemDefinition_ModsGroup(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getRelatedItemDefinition_OriginInfo(),
		...
		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				...
				.createEntry(MODSPackage.eINSTANCE
						...
						MODSFactory.eINSTANCE
								.createPhysicalDescriptionDefinition())));

		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getRelatedItemDefinition_ModsGroup(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getRelatedItemDefinition_RecordInfo(),
						MODSFactory.eINSTANCE.createRecordInfoDefinition())));

		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getRelatedItemDefinition_ModsGroup(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getRelatedItemDefinition_RelatedItem(),
						MODSFactory.eINSTANCE.createRelatedItemDefinition())));

		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getRelatedItemDefinition_ModsGroup(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getRelatedItemDefinition_Subject(),
		...
		newChildDescriptors
				.add(createChildParameter(MODSPackage.eINSTANCE
						...
						.createEntry(MODSPackage.eINSTANCE
								...
								MODSFactory.eINSTANCE
										.createTableOfContentsDefinition())));
		...
		newChildDescriptors
				.add(createChildParameter(MODSPackage.eINSTANCE
						...
						.createEntry(MODSPackage.eINSTANCE
								...
								MODSFactory.eINSTANCE
										.createTargetAudienceDefinition())));

		newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE
				.getRelatedItemDefinition_ModsGroup(), FeatureMapUtil
				.createEntry(MODSPackage.eINSTANCE
						.getRelatedItemDefinition_TitleInfo(),
		...
		newChildDescriptors
				.add(createChildParameter(MODSPackage.eINSTANCE
						...
						.createEntry(MODSPackage.eINSTANCE
								...
								MODSFactory.eINSTANCE
										.createTypeOfResourceDefinition())));
	}
