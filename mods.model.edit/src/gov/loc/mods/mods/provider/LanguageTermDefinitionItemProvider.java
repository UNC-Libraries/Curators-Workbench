...
/**
 * This is the item provider adapter for a {@link gov.loc.mods.mods.LanguageTermDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LanguageTermDefinitionItemProvider extends XsStringItemProvider implements IEditingDomainItemProvider,
     ...
     * @generated
     */
    public LanguageTermDefinitionItemProvider(AdapterFactory adapterFactory) {
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_LanguageTermDefinition_authority_feature",
					"_UI_LanguageTermDefinition_type"), MODSPackage.eINSTANCE
					.getLanguageTermDefinition_Authority(), true, false, false,
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description",
					...
					"_UI_LanguageTermDefinition_type"), MODSPackage.eINSTANCE
					.getLanguageTermDefinition_AuthorityURI(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_LanguageTermDefinition_type_feature",
					"_UI_LanguageTermDefinition_type"), MODSPackage.eINSTANCE
					.getLanguageTermDefinition_Type(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_LanguageTermDefinition_valueURI_feature",
					"_UI_LanguageTermDefinition_type"), MODSPackage.eINSTANCE
					.getLanguageTermDefinition_ValueURI(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This returns LanguageTermDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
	...
	String label = ((LanguageTermDefinition) object).getValue();
	return label == null || label.length() == 0 ? getString("_UI_LanguageTermDefinition_type")
			: getString("_UI_LanguageTermDefinition_type") + " " + label;
    }
