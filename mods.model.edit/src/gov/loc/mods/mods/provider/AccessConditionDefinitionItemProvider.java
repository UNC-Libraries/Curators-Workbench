 ...
 * @generated
 */
public class AccessConditionDefinitionItemProvider extends XsStringItemProvider
	...
	protected void addAltRepGroupPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_AccessConditionDefinition_type"),
				MODSPackage.eINSTANCE
						.getAccessConditionDefinition_AltRepGroup(), true,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_AccessConditionDefinition_displayLabel_feature"),
						getString(
								"_UI_PropertyDescriptor_description",
								"_UI_AccessConditionDefinition_displayLabel_feature",
								"_UI_AccessConditionDefinition_type"),
						MODSPackage.eINSTANCE
								.getAccessConditionDefinition_DisplayLabel(),
						true, false, false,
	...
	protected void addHrefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_AccessConditionDefinition_href_feature",
						"_UI_AccessConditionDefinition_type"),
				MODSPackage.eINSTANCE.getAccessConditionDefinition_Href(),
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_AccessConditionDefinition_type_feature",
						"_UI_AccessConditionDefinition_type"),
				MODSPackage.eINSTANCE.getAccessConditionDefinition_Type(),
				true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/AccessConditionDefinition"));
	}
	...
	public String getText(Object object) {
		String label = ((AccessConditionDefinition) object).getValue();
