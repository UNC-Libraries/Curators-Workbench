...
/**
 * This is the item provider adapter for a {@link gov.loc.mods.mods.NoteBaseDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NoteBaseDefinitionItemProvider extends UnstructuredTextDefinitionItemProvider implements
     ...
     * @generated
     */
    public NoteBaseDefinitionItemProvider(AdapterFactory adapterFactory) {
    ...
    /**
     * This returns NoteBaseDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
	...
	String label = ((NoteBaseDefinition) object).getID();
	return label == null || label.length() == 0 ? getString("_UI_NoteBaseDefinition_type")
			: getString("_UI_NoteBaseDefinition_type") + " " + label;
    }
