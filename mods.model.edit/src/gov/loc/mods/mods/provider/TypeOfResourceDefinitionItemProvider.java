...
/**
 * This is the item provider adapter for a {@link gov.loc.mods.mods.TypeOfResourceDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeOfResourceDefinitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
     ...
     * @generated
     */
    public TypeOfResourceDefinitionItemProvider(AdapterFactory adapterFactory) {
	...
	if (itemPropertyDescriptors == null) {
	    ...
	    addManuscriptPropertyDescriptor(object);
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_TypeOfResourceDefinition_value_feature",
					...
					.getTypeOfResourceDefinition_Value(), true, false, false,
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description",
					...
					"_UI_TypeOfResourceDefinition_type"), MODSPackage.eINSTANCE
					.getTypeOfResourceDefinition_AltRepGroup(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description",
					...
					"_UI_TypeOfResourceDefinition_type"), MODSPackage.eINSTANCE
					.getTypeOfResourceDefinition_Collection(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    /**
     * This adds a property descriptor for the Manuscript feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description",
					...
					"_UI_TypeOfResourceDefinition_type"), MODSPackage.eINSTANCE
					.getTypeOfResourceDefinition_Manuscript(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_TypeOfResourceDefinition_usage_feature",
					"_UI_TypeOfResourceDefinition_type"), MODSPackage.eINSTANCE
					.getTypeOfResourceDefinition_Usage(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This returns TypeOfResourceDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
