...
public class PartDefinitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_PartDefinition_iD_feature",
					"_UI_PartDefinition_type"), MODSPackage.eINSTANCE.getPartDefinition_ID(), true,
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_PartDefinition_lang_feature",
					"_UI_PartDefinition_type"), MODSPackage.eINSTANCE.getPartDefinition_Lang(),
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_PartDefinition_lang1_feature",
					"_UI_PartDefinition_type"), MODSPackage.eINSTANCE.getPartDefinition_Lang1(),
			true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_PartDefinition_order_feature",
					"_UI_PartDefinition_type"), MODSPackage.eINSTANCE.getPartDefinition_Order(),
			true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_PartDefinition_script_feature",
					"_UI_PartDefinition_type"), MODSPackage.eINSTANCE.getPartDefinition_Script(),
			true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_PartDefinition_transliteration_feature",
					"_UI_PartDefinition_type"), MODSPackage.eINSTANCE
					.getPartDefinition_Transliteration(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_PartDefinition_type_feature",
					"_UI_PartDefinition_type"), MODSPackage.eINSTANCE.getPartDefinition_Type(),
			true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getPartDefinition_Group(), FeatureMapUtil
			.createEntry(MODSPackage.eINSTANCE.getPartDefinition_Detail(),
					MODSFactory.eINSTANCE.createDetailDefinition())));

	newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getPartDefinition_Group(), FeatureMapUtil
			.createEntry(MODSPackage.eINSTANCE.getPartDefinition_Extent(),
					MODSFactory.eINSTANCE.createExtentDefinition())));

	newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getPartDefinition_Group(), FeatureMapUtil
			.createEntry(MODSPackage.eINSTANCE.getPartDefinition_Date(),
	...
	newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getPartDefinition_Group(), FeatureMapUtil
			.createEntry(MODSPackage.eINSTANCE.getPartDefinition_Text(),
