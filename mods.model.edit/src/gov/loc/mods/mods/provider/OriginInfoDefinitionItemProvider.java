...
public class OriginInfoDefinitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_OriginInfoDefinition_issuance_feature",
					...
					.getOriginInfoDefinition_Issuance(), true, false, false,
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_OriginInfoDefinition_altRepGroup_feature",
					"_UI_OriginInfoDefinition_type"), MODSPackage.eINSTANCE
					.getOriginInfoDefinition_AltRepGroup(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description",
					...
					"_UI_OriginInfoDefinition_type"), MODSPackage.eINSTANCE
					.getOriginInfoDefinition_DisplayLabel(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description",
					...
					"_UI_OriginInfoDefinition_type"), MODSPackage.eINSTANCE
					.getOriginInfoDefinition_Transliteration(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	newChildDescriptors
			.add(createChildParameter(MODSPackage.eINSTANCE.getOriginInfoDefinition_Group(),
					FeatureMapUtil.createEntry(MODSPackage.eINSTANCE
							.getOriginInfoDefinition_Frequency(), MODSFactory.eINSTANCE
