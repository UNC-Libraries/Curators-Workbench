...
public class DetailDefinitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_DetailDefinition_level_feature",
					"_UI_DetailDefinition_type"),
			MODSPackage.eINSTANCE.getDetailDefinition_Level(), true, false, false,
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_DetailDefinition_type_feature",
					"_UI_DetailDefinition_type"), MODSPackage.eINSTANCE.getDetailDefinition_Type(),
	...
	newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getDetailDefinition_Group(), FeatureMapUtil
			.createEntry(MODSPackage.eINSTANCE.getDetailDefinition_Number(),
	...
	newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getDetailDefinition_Group(), FeatureMapUtil
			.createEntry(MODSPackage.eINSTANCE.getDetailDefinition_Number(), MODSFactory.eINSTANCE
	...
	newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getDetailDefinition_Group(), FeatureMapUtil
			.createEntry(MODSPackage.eINSTANCE.getDetailDefinition_Caption(),
					MODSFactory.eINSTANCE.createXsString())));
	...
	newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getDetailDefinition_Group(), FeatureMapUtil
			.createEntry(MODSPackage.eINSTANCE.getDetailDefinition_Caption(), MODSFactory.eINSTANCE
					.createStringPlusAuthorityPlusTypePlusDisplayLabelPlusXlink())));
	...
	newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getDetailDefinition_Group(), FeatureMapUtil
			.createEntry(MODSPackage.eINSTANCE.getDetailDefinition_Title(),
					MODSFactory.eINSTANCE.createXsString())));
	...
	newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getDetailDefinition_Group(), FeatureMapUtil
			.createEntry(MODSPackage.eINSTANCE.getDetailDefinition_Title(), MODSFactory.eINSTANCE
					.createStringPlusAuthorityPlusTypePlusDisplayLabelPlusXlink())));
