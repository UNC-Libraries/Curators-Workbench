...
/**
 * This is the item provider adapter for a {@link gov.loc.mods.mods.CartographicsDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CartographicsDefinitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
     ...
     * @generated
     */
    public CartographicsDefinitionItemProvider(AdapterFactory adapterFactory) {
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description",
					...
					"_UI_CartographicsDefinition_type"), MODSPackage.eINSTANCE
					.getCartographicsDefinition_Authority(), true, false, false,
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description",
					...
					"_UI_CartographicsDefinition_type"), MODSPackage.eINSTANCE
					.getCartographicsDefinition_AuthorityURI(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
	...
	itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", "_UI_CartographicsDefinition_valueURI_feature",
					"_UI_CartographicsDefinition_type"), MODSPackage.eINSTANCE
					.getCartographicsDefinition_ValueURI(), true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    /**
     * This returns CartographicsDefinition.gif.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
	...
	String label = ((CartographicsDefinition) object).getAuthority();
	return label == null || label.length() == 0 ? getString("_UI_CartographicsDefinition_type")
			: getString("_UI_CartographicsDefinition_type") + " " + label;
    }
