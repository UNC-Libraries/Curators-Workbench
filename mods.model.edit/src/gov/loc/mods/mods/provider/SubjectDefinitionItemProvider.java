...
public class SubjectDefinitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addActuatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_actuate_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Actuate(), true, false,
	...
	protected void addAltRepGroupPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_altRepGroup_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_AltRepGroup(), true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addArcrolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_arcrole_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Arcrole(), true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAuthorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_authority_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Authority(), true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAuthorityURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_authorityURI_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_AuthorityURI(), true,
	...
	protected void addDisplayLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_displayLabel_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_DisplayLabel(), true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addHrefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_href_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Href(), true, false, false,
	...
	protected void addIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_iD_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_ID(), true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addLangPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_lang_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Lang(), true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addLang1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_lang1_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Lang1(), true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_role_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Role(), true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addScriptPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_script_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Script(), true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addShowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_show_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Show(), true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_title_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Title(), true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTransliterationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_transliteration_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Transliteration(), true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_type_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Type(), true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addUsagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_usage_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_Usage(), true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addValueURIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SubjectDefinition_valueURI_feature",
						"_UI_SubjectDefinition_type"), MODSPackage.eINSTANCE.getSubjectDefinition_ValueURI(), true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
				MODSPackage.eINSTANCE.getSubjectDefinition_Group(),
				FeatureMapUtil.createEntry(MODSPackage.eINSTANCE.getSubjectDefinition_Topic(),
		...
		newChildDescriptors.add(createChildParameter(
				MODSPackage.eINSTANCE.getSubjectDefinition_Group(),
				FeatureMapUtil.createEntry(MODSPackage.eINSTANCE.getSubjectDefinition_Geographic(),
						MODSFactory.eINSTANCE.createStringPlusAuthority())));
		...
		newChildDescriptors.add(createChildParameter(
				MODSPackage.eINSTANCE.getSubjectDefinition_Group(),
				FeatureMapUtil.createEntry(MODSPackage.eINSTANCE.getSubjectDefinition_Temporal(),
						MODSFactory.eINSTANCE.createTemporalDefinition())));

		newChildDescriptors.add(createChildParameter(
				MODSPackage.eINSTANCE.getSubjectDefinition_Group(),
				FeatureMapUtil.createEntry(MODSPackage.eINSTANCE.getSubjectDefinition_TitleInfo(),
						MODSFactory.eINSTANCE.createSubjectTitleInfoDefinition())));

		newChildDescriptors.add(createChildParameter(
				MODSPackage.eINSTANCE.getSubjectDefinition_Group(),
				FeatureMapUtil.createEntry(MODSPackage.eINSTANCE.getSubjectDefinition_Name(),
		...
		newChildDescriptors.add(createChildParameter(
				MODSPackage.eINSTANCE.getSubjectDefinition_Group(),
				FeatureMapUtil.createEntry(MODSPackage.eINSTANCE.getSubjectDefinition_Occupation(),
						MODSFactory.eINSTANCE.createStringPlusAuthority())));
		...
		newChildDescriptors.add(createChildParameter(
				MODSPackage.eINSTANCE.getSubjectDefinition_Group(),
				FeatureMapUtil.createEntry(MODSPackage.eINSTANCE.getSubjectDefinition_Genre(),
						MODSFactory.eINSTANCE.createGenreDefinition())));
	}
