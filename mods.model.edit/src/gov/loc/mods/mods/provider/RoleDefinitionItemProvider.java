...
/**
 * This is the item provider adapter for a {@link gov.loc.mods.mods.RoleDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleDefinitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	return getString("_UI_RoleDefinition_type");
    }
	...
	newChildDescriptors.add(createChildParameter(MODSPackage.eINSTANCE.getRoleDefinition_Group(), FeatureMapUtil
			.createEntry(MODSPackage.eINSTANCE.getRoleDefinition_RoleTerm(),
