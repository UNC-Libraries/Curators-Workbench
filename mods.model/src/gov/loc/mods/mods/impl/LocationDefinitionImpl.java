...
public class LocationDefinitionImpl extends EObjectImpl implements LocationDefinition {
	...
	if (physicalLocation == null) {
	    physicalLocation = new EObjectContainmentEList<PhysicalLocationDefinition>(
			    PhysicalLocationDefinition.class, this, MODSPackage.LOCATION_DEFINITION__PHYSICAL_LOCATION);
	}
	...
	lang1 = newLang1;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.LOCATION_DEFINITION__LANG1, oldLang1,
			    lang1));
    }
