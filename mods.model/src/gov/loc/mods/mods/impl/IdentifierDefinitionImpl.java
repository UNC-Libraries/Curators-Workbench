...
public class IdentifierDefinitionImpl extends XsStringImpl implements IdentifierDefinition {
	...
	invalidESet = true;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.IDENTIFIER_DEFINITION__INVALID,
			    oldInvalid, invalid, !oldInvalidESet));
    }
	...
	type = newType;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.IDENTIFIER_DEFINITION__TYPE, oldType,
			    type));
    }
