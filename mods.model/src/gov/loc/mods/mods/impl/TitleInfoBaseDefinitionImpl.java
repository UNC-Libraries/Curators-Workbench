...
public class TitleInfoBaseDefinitionImpl extends EObjectImpl implements TitleInfoBaseDefinition {
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET,
			    MODSPackage.TITLE_INFO_BASE_DEFINITION__AUTHORITY_URI, oldAuthorityURI, authorityURI));
    }
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET,
			    MODSPackage.TITLE_INFO_BASE_DEFINITION__DISPLAY_LABEL, oldDisplayLabel, displayLabel));
    }
	...
	href = newHref;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.TITLE_INFO_BASE_DEFINITION__HREF,
			    oldHref, href));
    }
	...
	lang = newLang;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.TITLE_INFO_BASE_DEFINITION__LANG,
			    oldLang, lang));
    }
	...
	lang1 = newLang1;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.TITLE_INFO_BASE_DEFINITION__LANG1,
			    oldLang1, lang1));
    }
	...
	role = newRole;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.TITLE_INFO_BASE_DEFINITION__ROLE,
			    oldRole, role));
    }
	...
	showESet = true;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.TITLE_INFO_BASE_DEFINITION__SHOW,
	...
	showESet = false;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.UNSET, MODSPackage.TITLE_INFO_BASE_DEFINITION__SHOW,
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET,
			    MODSPackage.TITLE_INFO_BASE_DEFINITION__TRANSLITERATION, oldTransliteration,
			    transliteration));
    }
	...
	typeESet = true;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.TITLE_INFO_BASE_DEFINITION__TYPE,
	...
	typeESet = false;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.UNSET, MODSPackage.TITLE_INFO_BASE_DEFINITION__TYPE,
