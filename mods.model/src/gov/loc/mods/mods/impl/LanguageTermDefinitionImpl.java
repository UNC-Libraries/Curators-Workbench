...
import gov.loc.mods.mods.LanguageAuthorityAttributeDefinition;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Language Term Definition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link gov.loc.mods.mods.impl.LanguageTermDefinitionImpl#getAuthority <em>Authority</em>}</li>
 *   <li>{@link gov.loc.mods.mods.impl.LanguageTermDefinitionImpl#getAuthorityURI <em>Authority URI</em>}</li>
 *   <li>{@link gov.loc.mods.mods.impl.LanguageTermDefinitionImpl#getType <em>Type</em>}</li>
 *   <li>{@link gov.loc.mods.mods.impl.LanguageTermDefinitionImpl#getValueURI <em>Value URI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LanguageTermDefinitionImpl extends XsStringImpl implements LanguageTermDefinition {
     ...
     * @ordered
     */
    protected static final LanguageAuthorityAttributeDefinition AUTHORITY_EDEFAULT = LanguageAuthorityAttributeDefinition.RFC3066;
     ...
     * @ordered
     */
    protected LanguageAuthorityAttributeDefinition authority = AUTHORITY_EDEFAULT;
     ...
     * @generated
     */
    protected LanguageTermDefinitionImpl() {
	super();
    }
	...
	return MODSPackage.eINSTANCE.getLanguageTermDefinition();
    }
     ...
     * @generated
     */
    public void setAuthority(LanguageAuthorityAttributeDefinition newAuthority) {
	LanguageAuthorityAttributeDefinition oldAuthority = authority;
	...
	typeESet = false;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.UNSET, MODSPackage.LANGUAGE_TERM_DEFINITION__TYPE,
