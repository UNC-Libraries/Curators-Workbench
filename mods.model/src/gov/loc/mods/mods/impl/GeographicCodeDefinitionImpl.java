...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Geographic Code Definition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link gov.loc.mods.mods.impl.GeographicCodeDefinitionImpl#getAuthority <em>Authority</em>}</li>
 *   <li>{@link gov.loc.mods.mods.impl.GeographicCodeDefinitionImpl#getAuthorityURI <em>Authority URI</em>}</li>
 *   <li>{@link gov.loc.mods.mods.impl.GeographicCodeDefinitionImpl#getValueURI <em>Value URI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeographicCodeDefinitionImpl extends XsStringImpl implements GeographicCodeDefinition {
     ...
     * @generated
     */
    protected GeographicCodeDefinitionImpl() {
	super();
    }
	...
	return MODSPackage.eINSTANCE.getGeographicCodeDefinition();
    }
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET,
			    MODSPackage.GEOGRAPHIC_CODE_DEFINITION__AUTHORITY_URI, oldAuthorityURI, authorityURI));
    }
