...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Temporal Definition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link gov.loc.mods.mods.impl.TemporalDefinitionImpl#getAuthority <em>Authority</em>}</li>
 *   <li>{@link gov.loc.mods.mods.impl.TemporalDefinitionImpl#getAuthorityURI <em>Authority URI</em>}</li>
 *   <li>{@link gov.loc.mods.mods.impl.TemporalDefinitionImpl#getValueURI <em>Value URI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemporalDefinitionImpl extends DateDefinitionImpl implements TemporalDefinition {
     ...
     * @generated
     */
    protected TemporalDefinitionImpl() {
	super();
    }
	...
	return MODSPackage.eINSTANCE.getTemporalDefinition();
    }
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.TEMPORAL_DEFINITION__VALUE_URI,
