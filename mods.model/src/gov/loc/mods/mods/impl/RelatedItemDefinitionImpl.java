...
public class RelatedItemDefinitionImpl extends EObjectImpl implements RelatedItemDefinition {
	...
	href = newHref;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.RELATED_ITEM_DEFINITION__HREF, oldHref,
			    href));
    }
	...
	role = newRole;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.RELATED_ITEM_DEFINITION__ROLE, oldRole,
			    role));
    }
	...
	type1ESet = false;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.UNSET, MODSPackage.RELATED_ITEM_DEFINITION__TYPE1,
