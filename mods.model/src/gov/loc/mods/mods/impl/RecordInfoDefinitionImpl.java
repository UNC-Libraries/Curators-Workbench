...
public class RecordInfoDefinitionImpl extends EObjectImpl implements RecordInfoDefinition {
	...
	lang = newLang;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.RECORD_INFO_DEFINITION__LANG, oldLang,
			    lang));
    }
	...
	script = newScript;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.RECORD_INFO_DEFINITION__SCRIPT,
			    oldScript, script));
    }
