...
public class UnstructuredTextDefinitionImpl extends XsStringImpl implements UnstructuredTextDefinition {
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET,
			    MODSPackage.UNSTRUCTURED_TEXT_DEFINITION__DISPLAY_LABEL, oldDisplayLabel, displayLabel));
    }
	...
	href = newHref;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.UNSTRUCTURED_TEXT_DEFINITION__HREF,
			    oldHref, href));
    }
	...
	role = newRole;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.UNSTRUCTURED_TEXT_DEFINITION__ROLE,
			    oldRole, role));
    }
	...
	showESet = true;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.UNSTRUCTURED_TEXT_DEFINITION__SHOW,
	...
	type = newType;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, MODSPackage.UNSTRUCTURED_TEXT_DEFINITION__TYPE,
			    oldType, type));
    }
