...
/**
	...
	ItemPropertyDescriptor result = null;
		...
		if (ip instanceof ItemProviderAdapter) {
		    ...
		    foreignAttributeDescriptors.put(ma.getMappedFeature(),
				    ipa.getPropertyDescriptor(o, ma.getMappedFeature()));
	    ...
	    result = new ItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
			    null, getString("_UI_MappedAttribute_defaultValue_feature"), getString(
