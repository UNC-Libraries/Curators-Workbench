...
/**
 * This is the item provider adapter for a {@link crosswalk.Paragraph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParagraphItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Paragraph_heading_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Paragraph_heading_feature", "_UI_Paragraph_type"),
				 CrosswalkPackage.Literals.PARAGRAPH__HEADING,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CrosswalkPackage.Literals.PARAGRAPH__TEXT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Paragraph)object).getHeading();
