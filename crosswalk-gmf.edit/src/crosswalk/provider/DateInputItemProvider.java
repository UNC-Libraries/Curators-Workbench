...
/**
 * This is the item provider adapter for a {@link crosswalk.DateInput} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DateInputItemProvider
         ...
         * @generated
         */
        public DateInputItemProvider(AdapterFactory adapterFactory) {
        ...
        protected void addInputPropertyDescriptor(Object object) {
                itemPropertyDescriptors.add
                        (createItemPropertyDescriptor
                                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                                 getResourceLocator(),
                                 getString("_UI_DateInput_Input_feature"),
                                 getString("_UI_PropertyDescriptor_description", "_UI_DateInput_Input_feature", "_UI_DateInput_type"),
                                 CrosswalkPackage.Literals.DATE_INPUT__INPUT,
                                 true,
                                 false,
                                 true,
                                 null,
        ...
        public Object getImage(Object object) {
                return overlayImage(object, getResourceLocator().getImage("full/obj16/DateInput"));
        }
        ...
        public String getText(Object object) {
                String label = ((DateInput)object).getName();
                return label == null || label.length() == 0 ?
                        getString("_UI_DateInput_type") :
                        getString("_UI_DateInput_type") + " " + label;
        }
        ...
        public void notifyChanged(Notification notification) {
                ...
                switch (notification.getFeatureID(DateInput.class)) {
