		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FileBlock_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FileBlock_name_feature", "_UI_FileBlock_type"),
				 CrosswalkPackage.Literals.FILE_BLOCK__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRequiredPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FileBlock_required_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FileBlock_required_feature", "_UI_FileBlock_type"),
				 CrosswalkPackage.Literals.FILE_BLOCK__REQUIRED,
				 true,
				 false,
				 false,
