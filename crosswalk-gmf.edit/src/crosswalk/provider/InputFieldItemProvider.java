...
/**
 * This is the item provider adapter for a {@link crosswalk.InputField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputFieldItemProvider
	 ...
	 * @generated
	 */
	public InputFieldItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InputField_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InputField_label_feature", "_UI_InputField_type"),
				 CrosswalkPackage.Literals.INPUT_FIELD__LABEL,
				 true,
				 false,
				 false,
	...
	protected void addUsagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InputField_usage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InputField_usage_feature", "_UI_InputField_type"),
				 CrosswalkPackage.Literals.INPUT_FIELD__USAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InputField"));
	}
