...
public class AclAdapterFactory extends AdapterFactoryImpl {
	 ...
	 */
        protected AclSwitch<Adapter> modelSwitch =
			...
			@Override
			public Adapter caseAccessControlType(AccessControlType object) {
				return createAccessControlTypeAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseGrantType(GrantType object) {
				return createGrantTypeAdapter();
			}
			@Override
	 ...
	 */
        ...
        /**
	 * Creates a new adapter for an object of class '{@link edu.unc.lib.schemas.acl.AccessControlType <em>Access Control Type</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 */
        ...
        /**
	 * Creates a new adapter for an object of class '{@link edu.unc.lib.schemas.acl.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
         * This default implementation returns null so that we can easily ignore cases;
         * it's useful to ignore a case when inheritance will catch all the cases anyway.
         * <!-- end-user-doc -->
	 ...
	 */
        ...
        /**
	 * Creates a new adapter for an object of class '{@link edu.unc.lib.schemas.acl.GrantType <em>Grant Type</em>}'.
	 * <!-- begin-user-doc -->
         * This default implementation returns null so that we can easily ignore cases;
         * it's useful to ignore a case when inheritance will catch all the cases anyway.
         * <!-- end-user-doc -->
