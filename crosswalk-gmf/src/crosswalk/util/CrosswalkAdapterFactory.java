...
public class CrosswalkAdapterFactory extends AdapterFactoryImpl {
	 ...
	 */
        protected CrosswalkSwitch<Adapter> modelSwitch =
			...
			@Override
			public Adapter caseOutputProfile(OutputProfile object) {
				return createOutputProfileAdapter();
			}
			@Override
			public Adapter caseDateToXMLGregorianCalenderConversion(DateToXMLGregorianCalenderConversion object) {
				return createDateToXMLGregorianCalenderConversionAdapter();
			}
			@Override
	...
	public Adapter createDateInputFieldAdapter() {
		return null;
								...
								/**
	 * Creates a new adapter for an object of class '{@link crosswalk.OutputProfile <em>Output Profile</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	public Adapter createOutputProfileAdapter() {
		return null;
								...
								/**
	 * Creates a new adapter for an object of class '{@link crosswalk.DateToXMLGregorianCalenderConversion <em>Date To XML Gregorian Calender Conversion</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
