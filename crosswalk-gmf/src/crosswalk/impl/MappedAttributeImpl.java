...
public class MappedAttributeImpl extends EObjectImpl implements MappedAttribute {
        ...
        public void setName(String newName) {
                ...
                if (eNotificationRequired())
                        eNotify(new ENotificationImpl(this, Notification.SET, CrosswalkPackage.MAPPED_ATTRIBUTE__NAME, oldName, name));
        }
        ...
        public InputConsumer getConsumer() {
                if (eContainerFeatureID() != CrosswalkPackage.MAPPED_ATTRIBUTE__CONSUMER) return null;
        ...
        public void setConsumer(InputConsumer newConsumer) {
                if (newConsumer != eInternalContainer() || (eContainerFeatureID() != CrosswalkPackage.MAPPED_ATTRIBUTE__CONSUMER && newConsumer != null)) {
                        ...
                        eNotify(new ENotificationImpl(this, Notification.SET, CrosswalkPackage.MAPPED_ATTRIBUTE__CONSUMER, newConsumer, newConsumer));
        }
        ...
        public StringGenerator getInput() {
                if (input != null && input.eIsProxy()) {
                        ...
                        if (input != oldInput) {
                                if (eNotificationRequired())
                                        eNotify(new ENotificationImpl(this, Notification.RESOLVE, CrosswalkPackage.MAPPED_ATTRIBUTE__INPUT, oldInput, input));
                        }
                }
                return input;
        }
        ...
        public void setInput(StringGenerator newInput) {
                ...
                inputESet = true;
                if (eNotificationRequired())
                        eNotify(new ENotificationImpl(this, Notification.SET, CrosswalkPackage.MAPPED_ATTRIBUTE__INPUT, oldInput, input, !oldInputESet));
        }
        ...
        public void unsetInput() {
                ...
                inputESet = false;
                if (eNotificationRequired())
                        eNotify(new ENotificationImpl(this, Notification.UNSET, CrosswalkPackage.MAPPED_ATTRIBUTE__INPUT, oldInput, null, oldInputESet));
        }
        ...
        public void updateRecord(EObject record) {
            ...
            System.out.println("my type instance class: "+mytype.getInstanceClass());
        	...
        	//if(a != null) {
        		 ...
        		 try {
        		     ...
        		     System.out.println("my attribute text: "+text);
        		     if(text != null) {
        ...
        public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
                if (baseClass == Input.class) {
                        switch (derivedFeatureID) {
                                case CrosswalkPackage.MAPPED_ATTRIBUTE__NAME: return CrosswalkPackage.INPUT__NAME;
                                case CrosswalkPackage.MAPPED_ATTRIBUTE__CONSUMER: return CrosswalkPackage.INPUT__CONSUMER;
                                default: return -1;
                        }
                }
                if (baseClass == StringInput.class) {
                        switch (derivedFeatureID) {
                                case CrosswalkPackage.MAPPED_ATTRIBUTE__INPUT: return CrosswalkPackage.STRING_INPUT__INPUT;
                                default: return -1;
                        }
                }
        ...
        public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
                if (baseClass == Input.class) {
                        switch (baseFeatureID) {
                                case CrosswalkPackage.INPUT__NAME: return CrosswalkPackage.MAPPED_ATTRIBUTE__NAME;
                                case CrosswalkPackage.INPUT__CONSUMER: return CrosswalkPackage.MAPPED_ATTRIBUTE__CONSUMER;
                                default: return -1;
                        }
                }
                if (baseClass == StringInput.class) {
                        switch (baseFeatureID) {
                                case CrosswalkPackage.STRING_INPUT__INPUT: return CrosswalkPackage.MAPPED_ATTRIBUTE__INPUT;
                                default: return -1;
                        }
                }
