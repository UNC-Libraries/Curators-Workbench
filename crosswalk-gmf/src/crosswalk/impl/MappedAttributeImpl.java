 ...
 * Feature</em>}</li>
 * <li>{@link crosswalk.impl.MappedAttributeImpl#getConversionStrategy <em>
 * Conversion Strategy</em>}</li>
 * <li>{@link crosswalk.impl.MappedAttributeImpl#getDefaultValue <em>Default
 * Value</em>}</li>
 * </ul>
 * </p>
 *
...
public class MappedAttributeImpl extends EObjectImpl implements MappedAttribute {
    ...
    /**
     * This is true if the Output reference has been set. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @generated
     * @ordered
    ...
    /**
     * The cached value of the '{@link #getConversionStrategy()
     * <em>Conversion Strategy</em>}' containment reference. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
    ...
    /**
     * This is true if the Conversion Strategy containment reference has been
	...
	if (output != null && output.eIsProxy()) {
		...
		if (eNotificationRequired())
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
				    CrosswalkPackage.MAPPED_ATTRIBUTE__OUTPUT, oldOutput, output));
	    }
	}
	return output;
    }
	...
	outputESet = true;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, CrosswalkPackage.MAPPED_ATTRIBUTE__OUTPUT, oldOutput,
	...
	outputESet = false;
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.UNSET, CrosswalkPackage.MAPPED_ATTRIBUTE__OUTPUT,
			    oldOutput, null, oldOutputESet));
    }
	...
	if (eNotificationRequired()) {
	    ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
			    CrosswalkPackage.MAPPED_ATTRIBUTE__CONVERSION_STRATEGY, oldConversionStrategy,
			    newConversionStrategy, !oldConversionStrategyESet);
	    if (msgs == null)
		msgs = notification;
	    else
	...
	if (newConversionStrategy != conversionStrategy) {
		...
		msgs = ((InternalEObject) conversionStrategy).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
				- CrosswalkPackage.MAPPED_ATTRIBUTE__CONVERSION_STRATEGY, null, msgs);
	    if (newConversionStrategy != null)
		msgs = ((InternalEObject) newConversionStrategy).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
				- CrosswalkPackage.MAPPED_ATTRIBUTE__CONVERSION_STRATEGY, null, msgs);
		...
		eNotify(new ENotificationImpl(this, Notification.SET,
				CrosswalkPackage.MAPPED_ATTRIBUTE__CONVERSION_STRATEGY, newConversionStrategy,
				newConversionStrategy, !oldConversionStrategyESet));
	}
    }
	...
	if (eNotificationRequired()) {
	    ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET,
			    CrosswalkPackage.MAPPED_ATTRIBUTE__CONVERSION_STRATEGY, oldConversionStrategy, null,
			    oldConversionStrategyESet);
	    if (msgs == null)
		msgs = notification;
	    else
		msgs.add(notification);
	...
	if (conversionStrategy != null) {
		...
		eNotify(new ENotificationImpl(this, Notification.UNSET,
				CrosswalkPackage.MAPPED_ATTRIBUTE__CONVERSION_STRATEGY, null, null,
				oldConversionStrategyESet));
	}
    }
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, CrosswalkPackage.MAPPED_ATTRIBUTE__DEFAULT_VALUE,
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.UNSET, CrosswalkPackage.MAPPED_ATTRIBUTE__DEFAULT_VALUE,
	...
	if (baseClass == Input.class) {
		...
		return CrosswalkPackage.MAPPED_ATTRIBUTE__OUTPUT;
	    default:
		return -1;
	    }
	}
