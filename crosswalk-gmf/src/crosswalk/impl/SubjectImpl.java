 ...
 * <em><b>Subject</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crosswalk.impl.SubjectImpl#getWalk <em>Walk</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubjectImpl extends InputConsumerImpl implements Subject {
    /**
    ...
    protected EClass eStaticClass() {
                return CrosswalkPackage.Literals.SUBJECT;
        }
    ...
    public CrossWalk getWalk() {
                if (eContainerFeatureID() != CrosswalkPackage.SUBJECT__WALK) return null;
    ...
    public NotificationChain basicSetWalk(CrossWalk newWalk, NotificationChain msgs) {
                msgs = eBasicSetContainer((InternalEObject)newWalk, CrosswalkPackage.SUBJECT__WALK, msgs);
                return msgs;
        }
    ...
    public void setWalk(CrossWalk newWalk) {
                if (newWalk != eInternalContainer() || (eContainerFeatureID() != CrosswalkPackage.SUBJECT__WALK && newWalk != null)) {
                        ...
                        eNotify(new ENotificationImpl(this, Notification.SET, CrosswalkPackage.SUBJECT__WALK, newWalk, newWalk));
        }
	...
	if (record instanceof ModsDefinition) {
	    ...
	    SubjectDefinition subject = MODSFactory.eINSTANCE.createSubjectDefinition();
		...
		if (i instanceof StringInput) {
			...
			try {
			    ...
			    if (str != null) {
				StringPlusAuthority sa = MODSFactory.eINSTANCE.createStringPlusAuthority();
				sa.setAuthority("local");
				sa.setValue(str);
				subject.getTopic().add(sa);
			    }
	    ...
	    if (subject.getTopic().size() > 0) {
		r.getSubject().add(subject);
	    }
	}
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
                switch (featureID) {
                        case CrosswalkPackage.SUBJECT__WALK:
                                if (eInternalContainer() != null)
                                        msgs = eBasicRemoveFromContainer(msgs);
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
                if (baseClass == OutputElement.class) {
                        switch (derivedFeatureID) {
                                case CrosswalkPackage.SUBJECT__WALK: return CrosswalkPackage.OUTPUT_ELEMENT__WALK;
                                default: return -1;
                        }
                }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
                if (baseClass == OutputElement.class) {
                        switch (baseFeatureID) {
                                case CrosswalkPackage.OUTPUT_ELEMENT__WALK: return CrosswalkPackage.SUBJECT__WALK;
                                default: return -1;
                        }
                }
	...
	return Subject.stringInputNames;
    }
