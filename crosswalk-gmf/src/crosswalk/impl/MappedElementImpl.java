...
/**
    ...
    public NotificationChain basicSetText(StringInput newText, NotificationChain msgs) {
                ...
                textESet = true;
                if (eNotificationRequired()) {
                        ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CrosswalkPackage.MAPPED_ELEMENT__TEXT, oldText, newText, !oldTextESet);
    ...
    public void setText(StringInput newText) {
                if (newText != text) {
                        NotificationChain msgs = null;
                        if (text != null)
                                msgs = ((InternalEObject)text).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CrosswalkPackage.MAPPED_ELEMENT__TEXT, null, msgs);
                        if (newText != null)
                                msgs = ((InternalEObject)newText).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CrosswalkPackage.MAPPED_ELEMENT__TEXT, null, msgs);
                        ...
                        textESet = true;
                        if (eNotificationRequired())
                                eNotify(new ENotificationImpl(this, Notification.SET, CrosswalkPackage.MAPPED_ELEMENT__TEXT, newText, newText, !oldTextESet));
                }
        }
    ...
    public NotificationChain basicUnsetText(NotificationChain msgs) {
                ...
                textESet = false;
                if (eNotificationRequired()) {
                        ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, CrosswalkPackage.MAPPED_ELEMENT__TEXT, oldText, null, oldTextESet);
                        if (msgs == null) msgs = notification; else msgs.add(notification);
                }
                return msgs;
        }
    ...
    public void unsetText() {
                if (text != null) {
                        ...
                        textESet = false;
                        if (eNotificationRequired())
                                eNotify(new ENotificationImpl(this, Notification.UNSET, CrosswalkPackage.MAPPED_ELEMENT__TEXT, null, null, oldTextESet));
                }
        }
