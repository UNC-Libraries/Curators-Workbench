 ...
 * <em><b>Language</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link crosswalk.impl.LanguageImpl#getWalk <em>Walk</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LanguageImpl extends InputConsumerImpl implements Language {
    /**
    ...
    protected EClass eStaticClass() {
                return CrosswalkPackage.Literals.LANGUAGE;
        }
    ...
    public CrossWalk getWalk() {
                if (eContainerFeatureID() != CrosswalkPackage.LANGUAGE__WALK) return null;
    ...
    public NotificationChain basicSetWalk(CrossWalk newWalk, NotificationChain msgs) {
                msgs = eBasicSetContainer((InternalEObject)newWalk, CrosswalkPackage.LANGUAGE__WALK, msgs);
                return msgs;
        }
    ...
    public void setWalk(CrossWalk newWalk) {
                if (newWalk != eInternalContainer() || (eContainerFeatureID() != CrosswalkPackage.LANGUAGE__WALK && newWalk != null)) {
                        ...
                        eNotify(new ENotificationImpl(this, Notification.SET, CrosswalkPackage.LANGUAGE__WALK, newWalk, newWalk));
        }
	...
	if (record instanceof ModsDefinition) {
	    ...
	    LanguageDefinition lang = MODSFactory.eINSTANCE.createLanguageDefinition();
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
                switch (featureID) {
                        case CrosswalkPackage.LANGUAGE__WALK:
                                if (eInternalContainer() != null)
                                        msgs = eBasicRemoveFromContainer(msgs);
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
                if (baseClass == OutputElement.class) {
                        switch (derivedFeatureID) {
                                case CrosswalkPackage.LANGUAGE__WALK: return CrosswalkPackage.OUTPUT_ELEMENT__WALK;
                                default: return -1;
                        }
                }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
                if (baseClass == OutputElement.class) {
                        switch (baseFeatureID) {
                                case CrosswalkPackage.OUTPUT_ELEMENT__WALK: return CrosswalkPackage.LANGUAGE__WALK;
                                default: return -1;
                        }
                }
	...
	return Language.stringInputNames;
    }
