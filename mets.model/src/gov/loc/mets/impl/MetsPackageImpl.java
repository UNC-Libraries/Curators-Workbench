...
public class MetsPackageImpl extends EPackageImpl implements MetsPackage {
	 ...
	 * @generated
	 */
	public EReference getSmLinkType_XlinkFrom() {
		return (EReference)smLinkTypeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getSmLinkType_XlinkTo() {
		return (EReference)smLinkTypeEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 */
		...
		createEReference(smLinkTypeEClass, SM_LINK_TYPE__XLINK_FROM);
		...
		createEReference(smLinkTypeEClass, SM_LINK_TYPE__XLINK_TO);
	 ...
	 */
		...
		initEReference(getSmLinkType_XlinkFrom(), ecorePackage.getEObject(), null, "xlinkFrom", null, 1, 1, SmLinkType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSmLinkType_XlinkTo(), ecorePackage.getEObject(), null, "xlinkTo", null, 1, 1, SmLinkType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
