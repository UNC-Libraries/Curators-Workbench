...
/**
 * This is the action bar contributor for the MODS model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class MODSActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
    ...
    protected IAction showPropertiesViewAction = new Action(
		    ModsEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
	@Override
	public void run() {
	    try {
    ...
    protected IAction refreshViewerAction = new Action(
		    ModsEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
	@Override
     ...
     * @generated
     */
    public MODSActionBarContributor() {
	...
	toolBarManager.add(new Separator("mods-settings"));
	toolBarManager.add(new Separator("mods-additions"));
    }
	...
	IMenuManager submenuManager = new MenuManager(ModsEditorPlugin.INSTANCE.getString("_UI_MODSEditor_menu"),
			"gov.loc.mods.modsMenuID");
	...
	//
	createChildMenuManager = new MenuManager(ModsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
	submenuManager.insertBefore("additions", createChildMenuManager);

	// Prepare for CreateSibling item addition or removal.
	//
	//createSiblingMenuManager = new MenuManager(ModsEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	if (selection instanceof IStructuredSelection && ((IStructuredSelection) selection).size() == 1) {
	    ...
	    //if (!(object instanceof ModsDefinition)) {
...
//	}
	...
	submenuManager = new MenuManager(ModsEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
	populateManager(submenuManager, createChildSubmenuActions, null);
	populateManager(submenuManager, createChildActions, null);
	menuManager.insertBefore("edit", submenuManager);

	//submenuManager = new MenuManager(ModsEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
